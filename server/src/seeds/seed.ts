    ...
    data: [
      {
        ...
        description:
          "An admin dashboard system built to manage participants in the K-State Cyber-Pipeline Program.",
      ...
      },
      {
        ...
        description:
          "A mock library management system built to practice writing and optimizing SQL queries.",
      ...
      },
      {
        ...
        description:
          "A point-of-sale system and website developed for a university OOP course project.",
